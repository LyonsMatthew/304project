...
(define apply-prim-proc
	(lambda (prim-proc args k)
			(case prim-proc
				...
				[(symbol->string) (apply-k k (symbol->string (1st args)))]
				[(string->symbol) (apply-k k (string->symbol (1st args)))]
				[(string-append) (apply-k k (apply string-append args))]
